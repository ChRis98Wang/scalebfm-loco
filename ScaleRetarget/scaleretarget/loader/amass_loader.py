...
from scaleretarget.loader.base_loader import BaseLoader, Mode, load_motion_manifest
...
class AmassLoader(BaseLoader):
    ...
    def load(self, data_path):
        ...
        if os.path.isdir(self.data_path):
            ...
            motion_manifest = self.config.get("motion_manifest")
            if motion_manifest:
                self.data_list = load_motion_manifest(
                    self.data_path,
                    motion_manifest,
                    allowed_suffixes=(".pkl", ".npz"),
                )
            else:
                self.data_list = []
